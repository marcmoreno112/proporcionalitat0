...
import { Igual, Flecha, DesplegablePorcentaje } from "./ElementosFórmulas";
import {
  Fraccion1y1ValoresFijos,
  Fraccion2y1ConDesplegables,
} from "./Fracción";
...
const ExplicacionPorcentaje: React.FC<FormulaComponentProps> = ({
  correctAnswer,
  // type,
  onToggle,
}) => {
  ...
  return (
    <div style={{ textAlign: "center", marginTop: "5px" }}>
      <CardTitle title="Partimos de una regla de 3 en la que cada elemento tiene un nombre. Después de la flecha, aislamos la que sería la X" />
      <div
        style={{
          display: "flex",
      ...
      >
        <Fraccion1y1ValoresFijos numerador1="%" numerador2="100" />
        <Igual />
        <Fraccion1y1ValoresFijos numerador1="Part" numerador2="Total" />
        <Flecha />
...
export default ExplicacionPorcentaje;
