...
const questions: Question[] = [
  {
    id: 77,
    enunciado:
      "Un minero ha tardado 18 días en extraer 50 bloques de diamante. Si lo hubieran hecho entre 6 mineros, ¿cuántos días habrían tardado?",
    enunciadoFeedback: `Un <span style="color: red;">minero</span> ha tardado 18 <span style="color: red;">días</span> en extraer 50 bloques de diamante. Si lo hubieran hecho entre 6 <span style="color: red;">mineros</span>, ¿cuántos días habrían tardado? <span style="color: blue;">Fíjate que los 50 bloques no son un dato importante: siempre hay los mismos bloques, no son un dato que estemos buscando o del que partamos.</span>`,
    p1: {
    ...
    p2: {
      ...
      feedbackIncorrecto: "Incorrecto. Cuantos más mineros, MENOS tiempo",
    },
    fórmula: {
      ...
      magnitudes: ["mineros", "días"],
    },
  },
  {
    id: 76,
    enunciado:
      "Un grupo de cocineros ha tardado 12 días en preparar un banquete. Si lo hubieran preparado entre 4 cocineros, ¿cuántos días habrían tardado?",
    enunciadoFeedback: `Un grupo de cocineros ha tardado 12 <span style="color: red;">días</span> en preparar un banquete. Si lo hubieran preparado entre 4 <span style="color: red;">cocineros</span>, ¿cuántos días habrían tardado?`,
    p1: {
      enunciado: "¿Es un problema de porcentajes?",
      respuestaCorrecta: "No",
      respuestaIncorrecta: "Sí",
    ...
    p2: {
      ...
      respuestaIncorrecta: "Sí",
      feedbackCorrecto: "Correcto, es inversa",
      feedbackIncorrecto: "Incorrecto. Cuantos más cocineros, MENOS tiempo",
    },
    fórmula: {
      formulaType: "regla3inversa",
      respuestaCorrecta: [
      ...
      magnitudes: ["cocineros", "días"],
    },
  },
  {
    id: 75,
    enunciado:
      "Un grupo de jardineros ha tardado 15 días en plantar un jardín. Si lo hubieran plantado entre 6 jardineros y todos trabajaran al mismo ritmo, ¿cuántos días habrían tardado?",
    enunciadoFeedback: `Un grupo de jardineros ha tardado 15 <span style="color: red;">días</span> en plantar un jardín. Si lo hubieran plantado entre 6 <span style="color: red;">jardineros</span> y todos trabajaran al mismo ritmo, ¿cuántos días habrían tardado?`,
    p1: {
      enunciado: "¿Es un problema de porcentajes?",
      respuestaCorrecta: "No",
      respuestaIncorrecta: "Sí",
    ...
    p2: {
      ...
      respuestaIncorrecta: "Sí",
      feedbackCorrecto: "Correcto, es inversa",
      feedbackIncorrecto: "Incorrecto. Cuantos más jardineros, MENOS tiempo",
    },
    fórmula: {
      formulaType: "regla3inversa",
      respuestaCorrecta: [
